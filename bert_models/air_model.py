...
df_train = pd.read_csv('data/full_data/train.csv')
df_val = pd.read_csv('data/full_data/valid.csv')
df_test = pd.read_csv('data/full_data/test.csv')
label_text = pd.read_csv('data/full_data/label_text.csv')
...
output_dir = "/home/paperspace/Documents/twitter/model/full_140_model/"
